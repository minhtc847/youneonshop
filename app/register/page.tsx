...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await registerNewUser({ email, first_name, last_name, telephone, password })
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black to-gray-900 px-4">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-white text-sm font-semibold">Phone</Label>
              <Input
                  id="phone"
                  type="number"
                  value={telephone}
            ...
            <Button type="submit"
                    className="w-full bg-neon-pink hover:bg-neon-pink/80 text-black font-bold py-3 rounded-md transition-all duration-300 transform hover:scale-105">
              Register
            </Button>
          </form>
          {/*<div className="mt-6">*/}
