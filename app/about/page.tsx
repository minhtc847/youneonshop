    ...
    <div className="container mx-auto px-4 py-16">
      ...
      >
        ...
        <p className="text-gray-300 max-w-2xl mx-auto">
          At Neon Lights, our mission is to illuminate Vietnam with creativity. We believe that lighting is more than just functionality – it's an art form that can transform spaces and evoke emotions. Our goal is to provide unique, high-quality neon products that allow our customers to express their individuality and bring their visions to life.
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        ...
        >
          ...
          <p className="text-gray-300">
            We're committed to reducing our environmental impact. Our LED neon alternatives offer the same vibrant glow with improved energy efficiency.
          </p>
        </motion.div>
      </div>
